            ...
            switch (str) {
                case "+":
                    if (hasChild()) {
                        ...
                        if (getRchild().hasChild()||getLchild().hasChild()) {
                            //判断左右邻括号的运算符是否为'/'
                            if (getRchild().equals("/")||getLchild().equals("/")) {
                                FractionStack f1 = new FractionStack();
                                f1.setNumerator(Integer.parseInt(getLchild().getLchild().getResult(arrayList)));
                                f1.setDenominator(Integer.parseInt(getLchild().getRchild().getResult(arrayList)));
                                FractionStack f2 = new FractionStack();
                                ...
                                f2.setDenominator(Integer.parseInt(getRchild().getRchild().getResult(arrayList)));
                                FractionCal f=new FractionCal();
                                return f.fracAdd(f1, f2).getRes();

                            }}
                    }
                    return String.valueOf(Integer.parseInt(getLchild().getResult(arrayList)) + Integer.parseInt(getRchild().getResult(arrayList)));
                case "-":
                    if (Integer.parseInt(getRchild().getResult(arrayList)) < Integer.parseInt(getLchild().getResult(arrayList)) || Integer.parseInt(getRchild().getResult(arrayList)) == Integer.parseInt(getLchild().getResult(arrayList))) {
                        if (hasChild()) {
                            //左右子树如果有孩子，说明右子树是一个表达式，而不是数字节点。
                            if (getRchild().hasChild()||getLchild().hasChild()) {
                                //判断左右邻括号的运算符是否为'/'
                    ...
                    if (getRchild().getResult(arrayList).equals("0")) {
                        ...
                        if (getRchild().hasChild()||getLchild().hasChild()) {
                            ...
                            if (getRchild().equals("/")||getLchild().equals("/")) {
                                ...
                                f2.setDenominator(Integer.parseInt(getRchild().getRchild().getResult(arrayList)));
                                FractionCal f=new FractionCal();
                                return f.fractDiv(f1, f2).getRes();
         ...
         switch (str) {
             ...
             case "-":
                 if (Integer.parseInt(getRchild().getResult(arrayList)) < Integer.parseInt(getLchild().getResult(arrayList)) || Integer.parseInt(getRchild().getResult(arrayList)) == Integer.parseInt(getLchild().getResult(arrayList)))
                     ...
                     return String.valueOf(Integer.parseInt(getRchild().getResult(arrayList)) - Integer.parseInt(getLchild().getResult(arrayList)));
             case "*":
                 return String.valueOf(Integer.parseInt(getLchild().getResult(arrayList)) * Integer.parseInt(getRchild().getResult(arrayList)));
             case "/":
                 if (getRchild().getResult(arrayList).equals("0")) {
