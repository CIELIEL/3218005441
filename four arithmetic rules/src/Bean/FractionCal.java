...
public class FractionCal {
    ...
    public FractionStack fracAdd(FractionStack f1, FractionStack f2) {
        ...
        int first_numerator = f1.getNumerator();
        int first_denominator = f1.getDenominator();
        int second_numrator = f2.getNumerator();
        int second_denominator = f2.getDenominator();
        int denominator;
        int numerator;
    ...
    public FractionStack fracSub(FractionStack f1, FractionStack f2) {
        ...
        int first_numerator = f1.getNumerator();
        int first_denominator = f1.getDenominator();
        int second_numerator = f2.getNumerator();
        int second_denominator = f2.getDenominator();
        int denominator;
        int numerator;
...
/*    public FractionStack fracAdd(FractionStack f1,FractionStack f2){
    ...
    public FractionStack fracSub(FractionStack f1,FractionStack f2){
        ...
        if(first_denominator==second_denominator)  //分母相同时减分子
        {
            denominator=first_denominator;
            numerator=first_numerator-second_numerator;
