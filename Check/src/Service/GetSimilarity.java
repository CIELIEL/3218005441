...
public class GetSimilarity {
    public double getSimilarity(String Str1,String Str2){
        ...
        //String Str1_1=Str1;
        //String Str2_1=Str2;
        String Str1_1=new StringFilter().stringFilter(Str1);//去标点符号
        String Str2_1=new StringFilter().stringFilter(Str2);//去标点符号
    ...
    public  Service.GetSimilarity(String S1, String S2) {
